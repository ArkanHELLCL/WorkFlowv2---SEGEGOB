						...
						<div class="col-sm-12 col-md-12 col-lg-12">
							<div class="md-form input-with-post-icon">
								<div class="error-message">								
									...
									<label for="" class="select-label active">Departamento Actual</label>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="col-sm-12 col-md-12 col-lg-12">
							<div class="md-form input-with-post-icon">
								<div class="error-message">								
									...
									<span class="select-bar"></span>
									<label for="" class="select-label active">Editor Actual</label>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="col-sm-12 col-md-12 col-lg-12">
							<div class="md-form input-with-post-icon">
								<div class="error-message">								
									...
									<span class="select-bar"></span>
									<label for="" class="select-label active">Nombre del Requerimiento Actual</label>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="col-sm-12 col-md-12 col-lg-12">
							<div class="md-form input-with-post-icon">
								<div class="error-message">								
									...
									<span class="select-bar"></span>
									<label for="" class="select-label">Nuevo Nombre del Requerimiento</label>
								</div>
							</div>
						</div>
					</div>							
