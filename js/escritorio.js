...
$(document).ready(function(e) {
	...
	var urltheme = "http://" + host + "/vendor/jquery/css/" + theme + ".jquery-ui.css";
	$("#ui-theme").attr('href',urltheme);
	
	urltheme = "http://" + host + "/vendor/bootstrap/css/" + bootstrapTheme;
...
function wrk_informesgenerales(Informe,worker,infname,columns,EST_Id,USR_Id,USR_Identificador){
	if("undefined" !== typeof Worker){
		var miWorker = new Worker(worker); // Como argumento le pasamos la ruta del script
		var csvFileData;
		var row = [];
		...
		var data={Informe:Informe,EST_Id,EST_Id,USR_Id:USR_Id,USR_Identificador:USR_Identificador};
		//console.log(data)
