												...
												<div class="col-sm-12 col-md-12 col-lg-4">
													<div class="md-form input-with-post-icon">
														<div class="error-message">								
															...
															<input type="text" id="USR_Usuario" name="USR_Usuario" class="form-control" required value="<%=USR_Usuario%>">
												...
												<div class="col-sm-12 col-md-12 col-lg-5">
													<div class="md-form input-with-post-icon">
														<div class="error-message">								
															...
															<input type="email" id="USR_Mail" name="USR_Mail" class="form-control" required value="<%=USR_Mail%>">
															<span class="select-bar"></span>
			...
			if($("#frmusuarios").valid()){
				...
				if(parseInt(width)==230 && parseInt(height)==120 || !imgchange) {
					$.ajax({
						...
						data: $("#frmusuarios").serialize() + "&USR_Estado=" + USR_Estado + "&USR_Jefatura=" + USR_Jefatura + "&USR_LDAP=" + USR_LDAP + "&USR_Reset=" + USR_Reset,
						dataType: "json",
						success: function(data) {						
							if(data.state=="200"){
								if(mode=="add"){
