...
<%	
	...
	datos = PER_Id & "," & USR_Rut & ",'" & USR_Dv & "'," & USR_Estado & ",'" & USR_Usuario & "','" & USR_Telefono & "','" & USR_Mail & "','" & USR_Nombre & "','" & USR_Apellido & "'," & SEX_Id & "," & DEP_Id & "," & USR_Jefatura	& ",'" & USR_Firma & "'," & USR_LDAP & "," &  session("wk2_usrid") & ",'" & session("wk2_usrtoken") & "'" 
