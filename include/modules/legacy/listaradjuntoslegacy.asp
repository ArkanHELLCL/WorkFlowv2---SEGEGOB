...
<%		
	...
	if(INF_Id=1) then
        ...
        path="e:\DocumentosSistema\WorkFlow\legacy\workflowv1\REQ-" & CInt(Req_Cod) & "\CDP\"
        ...
        if(INF_Id=2) then
            'Memo
            path="e:\DocumentosSistema\WorkFlow\legacy\workflowv1\REQ-" & CInt(Req_Cod) & "\MEMO\"
            ...
            if(INF_Id=3) then
                'Bases
                path="e:\DocumentosSistema\WorkFlow\legacy\workflowv1\REQ-" & CInt(Req_Cod) & "\BASES\"
