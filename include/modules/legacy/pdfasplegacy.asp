...
<%	
    ...
    if(CInt(INF_Id=1)) then
        ...
        'dir="e:\DocumentosSistema\WorkFlow\legacy\workflowv1\REQ-" & CInt(DRE_Id) & "\CDP\"
        ...
        if(CInt(INF_Id=2)) then
            'Memo
            'dir="e:\DocumentosSistema\WorkFlow\legacy\workflowv1\REQ-" & CInt(DRE_Id) & "\MEMO\"
            ...
            if(CInt(INF_Id=3)) then
                'Bases
                'dir="e:\DocumentosSistema\WorkFlow\legacy\workflowv1\REQ-" & CInt(DRE_Id) & "\BASES\"
